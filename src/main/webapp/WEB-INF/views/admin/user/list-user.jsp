...
<link href="${base}/css/users/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link href="${base}/css/admin/list-user.css" rel="stylesheet">
...
<script type="text/javascript" src="${base}/js/admin/delete-user.js"></script>
								...
								<tbody style="border: 1px solid #b5b5b5">
									<c:forEach items="${users }" var="user">
										<tr>
											...
											<td><a href="${base }/admin/edit-user/${user.id }" class="btn btn-primary btn-sm"><svg
